...
<body>	
		  ...
		  <h2>My Requests / <a href="AcceptedRequests.php">Accepted Requests</a></h2>
	  

			<?php
			$offerArray=getRequstedOffer($username,$userid);
			 ...
			 <table width="800px" id="item_<?php echo $column[12];?>" >	
			 	...
			 	<h3  id="item2_<?php echo $column[12];?>" ><i><?php echo $column[11];?></i> claims your offer! Do you want to accept his request?</h3>	
			    ...
			    <tr >
			    	...
			    	<td >
			    		...
			    		<br /><br />
			    		<button class="button_yes button_del" id="del-<?php echo $column[12];?>" style="border: none; width: 70px;">Yes</button>    		
			    		<button class="button_no button_del" id="del-<?php echo $column[12];?>" style="border: none; width: 70px;">No</button>
