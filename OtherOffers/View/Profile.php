...
<head>
			...
			<title><?php echo "$username"; ?>'s Offers</title>
...
<body>	
		...
		<h2><?php echo "$username"; ?>'s Offers</h2>
			 ...
			 <br />
			  <table width="800px"  >
			    ...
			    <tr ><td ><img id="serviceIcon" src="../View/img/<?php echo $column[1];?>.png" /></td>
			    	...
			    	<td>
			    		<button type="button" class="button_mes small pop1" value="<?php echo $username;?>">Message <?php echo $username;?></button>
			...
			<div id="popup">
		       ...
		       <!--  If you can't get it up use<br><span class="logo">bPopup</span>-->
				...
				<input type="hidden" id="from_user" name="from_user" maxlength="32" value =" <?php echo $G; ?>">
