...
function save_offer_request($to_user,$from_user,$offer_id){
							//echo "$to_user_$from_user_$offer_id";
							$accepted=0;
							try{
								$con=users_db_connect();
								 ...
								 $sql="INSERT INTO requests (to_user, from_user, offer_id_fgn,accepted)
										  VALUES (:to, :from, :id, :accepted)";
									$q = $con->prepare($sql);
