...
<head>
			...
			<meta charset="utf-8">
  			...
  			<script src="../Controller/js/jquery.bpopup.min.js"></script>    
...
<body>	
			...
			<div id="popup">
		       ...
		       <!--  If you can't get it up use<br><span class="logo">bPopup</span>-->
				...
				<input type="button" name="submit" class="button_sub just_button small pop1" value="Send Message" >
				</form>
		    </div>
			</section> 
         	<!-- MESSAGE POPUP-->
		...
		if((isset($_POST['cleaning']))||(isset($_POST['sitting']))||(isset($_POST['walk']))){
			
			if(isset($_POST['cleaning'])&&$_POST['cleaning']=="on"){$check1="checked";}
			if(isset($_POST['sitting'])&&$_POST['sitting']=="on"){$check2="checked";}
			if(isset($_POST['walk'])&&$_POST['walk']=="on"){$check3="checked";}
		...
		<form action="Home.php" method="post">
			...
			<input type="checkbox" name="cleaning" class="just_button"  <?php echo "$check1";?>>Doggie Cleaner
			<input type="checkbox" name="sitting"  class="just_button" <?php echo "$check2";?>>Doggie Sitter
			<input type="checkbox" name="walk"    class="just_button"  <?php echo "$check3";?>>Doggie Walker&nbsp&nbsp&nbsp
			<input type="submit" name="submit "class="just_button" value="Filter"><br><br>
			...
			if((isset($_POST['cleaning']))||(isset($_POST['sitting']))||(isset($_POST['walk']))){
				...
				$offerArray=getOfferData($userid,$cleaning,$sitting,$walking);
			
			}
			else{
						
				$offerArray=getOfferData($userid,"on","on","on");
				
			}

			 ?>
			 <br />
			 	<?php foreach (array_reverse($offerArray) as $column) { ?>
			 					<br />
			 <table width="800px"  >
			    ...
			    <tr ><td ><img id="serviceIcon" src="../View/img/<?php echo $column[1];?>.png" /></td>
			    	...
			    	<td ><button  class="just_button" onclick="window.location.href='../../OtherOffers/View/Profile.php?u=<?php echo $column[10];?>&id=<?php echo $column[2];?>'">View <?php echo $column[10];?>'s Offers</button>
			    		<br /><br />
