...
<body>	
		...
		<h2>You Must Confirm your Email!</h2>
		
		<h2>Hurry Up! awesome staff awaits you inside. </h2>
		<img id="doge" src="../View/forma/images/doge.png" alt="Puppy Maker" />

		
		<section id="buttons">
			
			<input type="Button" name="Home" id="createaccbtn" class="createaccbtn" tabindex="1" value="Re-Send Email & Go to Inbox"onclick="window.location.href='../Controller/goToInbox.php'">
			<br style="clear:both;">
		</section>
