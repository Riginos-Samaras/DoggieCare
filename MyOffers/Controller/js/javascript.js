$(document).ready(function() {
	...
	$('#upload-button .upload').click(function() {
		...
		$.each(dataArray, function(index, file) {	
			...
			$.post('../Controller/upload.php', dataArray[index], function(data) {
				...
				if(dataSplit[1] == 'uploaded successfully') {
					var realData = '<li><a href="../../Files/images/'+dataSplit[0]+'">'+fileName+'</a> '+dataSplit[1]+'</li>';
					
					$('#uploaded-files').append('<li><a href="../../Files/images/'+dataSplit[0]+'">'+fileName+'</a> '+dataSplit[1]+'</li>');
					...
					$('#uploaded-files').append('<li><a href="../../Files/images/'+data+'. File Name: '+dataArray[index].name+'</li>');
				}
